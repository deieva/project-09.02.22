        ...
        <div>
            <div>
                <div className="footer">
                    <section>
                        <h3 className="footer-section">XRIGADE</h3>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt.</p>
                    </section>
                    <section>
                        <h3 className="footer-section">LINKS</h3>
                        <a href="#">Home</a>
                        <a href="#">About Us</a>
                        <a href="#">Blog</a>
                        <a href="#">Contact Us</a>
                    ...
                    <section>
                        <h3 className="footer-section">OTHER</h3>
                        <a href="#">Privacy Policy</a>
                        <a href="#">Terms and Conditions</a>
                        <a href="#">Cookie Policy</a>
                    </section>
                    <section>
                        <h3 className="footer-section">ANY QUESTIONS?</h3>
